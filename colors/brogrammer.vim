...
hi MatchParen ctermfg=197 ctermbg=NONE cterm=underline guifg=#e74c3c guibg=NONE gui=underline
...
hi Search term=reverse cterm=bold ctermfg=232 ctermbg=196 gui=bold guifg=#f7f3ff guibg=#e14d42
hi IncSearch term=reverse cterm=bold ctermfg=232 ctermbg=39 gui=bold guifg=#000000 guibg=#6c71c4
...
hi Conditional ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
hi Constant ctermfg=62 ctermbg=NONE cterm=NONE guifg=#6c71c4 guibg=NONE gui=NONE
hi Define ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi ErrorMsg ctermfg=15 ctermbg=197 cterm=NONE guifg=#ffffff guibg=#e74c3c gui=NONE
hi WarningMsg ctermfg=15 ctermbg=197 cterm=NONE guifg=#ffffff guibg=#e74c3c gui=NONE
...
hi Keyword ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi Operator ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
hi PreProc ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi Statement ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi SpellBad term=reverse ctermfg=197 ctermbg=224 gui=undercurl guisp=Red
hi rubyClass ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi rubyInclude ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi rubyControl ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
hi rubyClassVariable ctermfg=172 ctermbg=NONE cterm=NONE guifg=#e67e22 guibg=NONE gui=NONE
hi rubyOperator ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
hi rubyException ctermfg=197 ctermbg=NONE cterm=bold guifg=#e74c3c guibg=NONE gui=bold
...
hi htmlTag ctermfg=197 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=NONE
hi htmlEndTag ctermfg=197 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=NONE
hi htmlTagName ctermfg=197 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=NONE
hi htmlArg ctermfg=197 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=NONE
...
if exists("g:brogrammer_nobg") && g:brogrammer_nobg
